...
def setup_logging(output_dir):
    ...
    # Create formatter used by both handlers
...
def main():
    ...
    if config.get('run_pretraining', True):
        ...
        logger.info(f"Pretraining completed. Model saved at: {pretrained_path}")
    ...
    if config.get('run_finetuning', True):
        ...
        logger.info(f"Fine-tuning completed. Model saved at: {finetuned_path}")
